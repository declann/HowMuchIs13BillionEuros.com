...
import { MergeView, unifiedMergeView, updateOriginalDoc, originalDocChangeEffect, getOriginalDoc } from "../../_node/@codemirror/merge@6.6.3/index.b871f7e4.js"
import { EditorView  } from "../../_node/codemirror@6.0.1/index.0fd7eda9.js"
import { EditorView as  EditorView_old } from "../../_node/codemirror@6.0.1/index.0fd7eda9.js" // needed for merge view ?!
//import { basicSetup } from "codemirror"
import { basicSetup } from "../../_node/codemirror@6.0.1/index.0fd7eda9.js"
import { ViewPlugin, Decoration, WidgetType } from "../../_node/@codemirror/view@6.33.0/index.836a6482.js";

import { EditorState } from "../../_node/@codemirror/state@6.4.1/index.66d24d9c.js"
import { linter, lintGutter } from "../../_node/@codemirror/lint@6.8.1/index.ee129630.js"
import { ChangeSet } from "../../_node/@codemirror/state@6.4.1/index.66d24d9c.js"

import { Text } from "../../_node/@codemirror/state@6.4.1/index.66d24d9c.js"

import * as eslint from "../../_node/eslint-linter-browserify@9.10.0/index.9c03d13d.js";
import { javascript, esLint, javascriptLanguage } from "../../_node/@codemirror/lang-javascript@6.2.2/index.fe693d67.js";
import { foldGutter, indentOnInput, syntaxHighlighting, defaultHighlightStyle, bracketMatching, foldKeymap, syntaxTree, foldAll } from "../../_node/@codemirror/language@6.10.2/index.372ccf5f.js";
import globals from "../../_node/globals@15.9.0/index.d82c0643.js";
...
import { instance } from "../../_node/@viz-js/viz@3.9.0/index.20a70c76.js";
import {html} from "../../_node/htl@0.3.1/index.0caf36e7.js";

import snippetbuilder from "../../_node/codemirror-6-snippetbuilder@1.0.1/index.200343b8.js";
